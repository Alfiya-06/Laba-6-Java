...
public class ValidateProcessor {
    ...
    /**
     * Выводит список типов, указанных в аннотации @Validate.
     * @param obj Объект, класс которого нужно проверить на наличие аннотации @Validate.
     */
    public static void process(Object obj) {
        if (obj == null) {
            System.out.println("Ошибка: передан null объект для обработки @Validate.");
            return;
        }
